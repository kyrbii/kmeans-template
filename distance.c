...
long double compute_manhattan_distance(int d, const double x1[d], const double x2[d]) {
    long double aggr_distance = 0.;
    for (int i = 0; i < d; i++) {
...
long double compute_euclidean_distance(int d, const double x1[d], const double x2[d]) {
    long double aggr_distance = 0.;
    for (int i = 0; i < d; i++) {
